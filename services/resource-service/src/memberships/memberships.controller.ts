...
import { ApiTags, ApiOperation, ApiBearerAuth, ApiCreatedResponse, ApiOkResponse, ApiForbiddenResponse, ApiNotFoundResponse } from '@nestjs/swagger';
...
export class MembershipsController {
  ...
  @ApiCreatedResponse({ description: 'Membership request submitted successfully.' })
